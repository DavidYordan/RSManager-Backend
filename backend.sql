...
INSERT INTO role_permission (role_id, role_name, permission_id, permission_name, rate1, rate2) VALUES
    (1, '管理员', 1, '一级抽佣', 0.95, 0.3),
    (1, '管理员', 2, '二级抽佣', 0.95, 0.1),
    (1, '管理员', 3, '三级抽佣', 0.95, 0),
    (2, '主管', 1, '一级抽佣', 0.95, 0.3),
    (2, '主管', 2, '二级抽佣', 0.95, 0.1),
    (2, '主管', 3, '三级抽佣', 0.95, 0),
    (3, '销售', 1, '一级抽佣', 0.95, 0.3),
    (3, '销售', 2, '二级抽佣', 0.95, 0.1),
    (3, '销售', 3, '三级抽佣', 0.95, 0),
    (4, '高阶学员', 1, '一级抽佣', 0.95, 0.3),
    (4, '高阶学员', 2, '二级抽佣', 0.95, 0.1),
    (4, '高阶学员', 3, '三级抽佣', 0.95, 0),
    (5, '中阶学员', 1, '一级抽佣', 0.95, 0.3),
    (5, '中阶学员', 2, '二级抽佣', 0.95, 0.1),
    (5, '中阶学员', 3, '三级抽佣', 0.95, 0),
    (6, '初阶学员', 1, '一级抽佣', 0.95, 0.3),
    (6, '初阶学员', 2, '二级抽佣', 0.95, 0.1),
    (6, '初阶学员', 3, '三级抽佣', 0.95, 0),
    (7, '投手', 1, '一级抽佣', 0.95, 0.3),
    (7, '投手', 2, '二级抽佣', 0.95, 0.1),
    (7, '投手', 3, '三级抽佣', 0.95, 0),
    (8, '财务', 1, '一级抽佣', 0.95, 0.3),
    (8, '财务', 2, '二级抽佣', 0.95, 0.1),
    (8, '财务', 3, '三级抽佣', 0.95, 0),
    (9, '导师', 1, '一级抽佣', 0.95, 0.3),
    (9, '导师', 2, '二级抽佣', 0.95, 0.1),
    (9, '导师', 3, '三级抽佣', 0.95, 0);
